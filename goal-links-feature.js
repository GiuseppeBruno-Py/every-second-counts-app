...
function goalLinksInstallUi() {
  ...
  metricField.insertAdjacentHTML('beforebegin', `<div class="field goal-links-field" id="goalLinksField"><label>Itens que alimentam esta meta</label><p class="field-hint">O progresso da meta será a média dos estudos e leituras selecionados. Sem vínculos, ela continua sendo medida manualmente por dias.</p><div class="goal-links-list" id="goalLinksList"></div></div>`);
